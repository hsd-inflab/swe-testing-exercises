...
Maven-Konvention: Produktivcode unter `src/main/java`, Tests unter `src/test/java`. Basis-Package: `ex<NN>` (z. B. `ex20` für Aufgabe 20). Sollen Eigentumsverhältnisse oder fachliche Gruppen abgebildet werden, geht das per Subpackage (z. B. `ex20.orderingplatform`, `ex20.riskassessment`).
