...
3. **Unit of Work:** Bestimme zuerst, welche Klassen zum Unit of Work (UoW) gehören (Tipp: nicht jede Klasse unter `ex06.billingplatform.*` ist UoW-Code, z. B. ist die Demo-`App` keiner und reine Datentypen sind es auch nicht). Erstelle dann in der Notation aus der Vorlesung die **Entry Points** und **Exit Points** des UoW.
