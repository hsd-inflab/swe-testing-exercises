# Aufgabe 21 - Test Doubles: Invoice Processing
...
| -------------------------- | ------------------------------------------------------------- | ------------ |
| `ex21.billingplatform.*`   | Unser Team (BillingPlatform): Verarbeitung der Rechnungen     | ja           |
| `ex21.renderingservice.*`  | Externer Dienst RenderingService: PDF-Rendering               | **nein**     |
| `ex21.maildelivery.*`      | Externer Dienst MailDelivery: Mail-Versand                    | **nein**     |
...
```bash
mvn -q compile
java -cp target/classes ex21.billingplatform.App
```
